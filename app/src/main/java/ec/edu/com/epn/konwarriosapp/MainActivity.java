...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_artistas) {
            ...
            Intent llamadoBuscar = new Intent(this, Buscar.class);
            startActivity(llamadoBuscar);
        } else if (id == R.id.nav_creditos) {
            Intent llamadoCreditos = new Intent(this, Informacion.class);
            startActivity(llamadoCreditos);
        }
